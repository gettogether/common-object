...
namespace CommonLibrary.Utility
{
    public class LanguageHelper
    {
        ...
        private static PinYin _PY = new PinYin();
        ...
        public class PinYin
        {
            ...
            private string _PinYinAbbreviation;
            private string _PinYinFullCode;
            private string _PinYinFullCodeWithSpace;
            private string _PinYinInput;
            private static string[] _PinYinString;
            private static int[] _PinYinValue;
            ...
            public string GetAbbrName(string name)
            {
                this._PinYinInput = name;
                this.GetPyCode();
                return this._PinYinAbbreviation;
            }
            ...
            public string GetFullName(string name)
            {
                this._PinYinInput = name;
                this.GetPyCode();
                return this._PinYinFullCode;
            }

            public string GetFullNameWithSpace(string name)
            {
                this._PinYinInput = name;
                this.GetPyCode();
                return this._PinYinFullCodeWithSpace;
            }

            private bool GetPyCode()
            {
                this._PinYinFullCode = "";
                this._PinYinFullCodeWithSpace = "";
                this._PinYinAbbreviation = "";
                byte[] buffer1 = new byte[2];
                int num1 = 0;
                int num2 = 0;
                int num3 = 0;
                char[] chArray1 = this._PinYinInput.ToCharArray();
                for (int num4 = 0; num4 < chArray1.Length; num4++)
                {
                    ...
                    if (num2 <= 0x7f)
                    {
                        this._PinYinFullCode = this._PinYinFullCode + chArray1[num4];
                        this._PinYinFullCodeWithSpace = this._PinYinFullCodeWithSpace + chArray1[num4];
                        this._PinYinFullCodeWithSpace = this._PinYinFullCodeWithSpace + " ";
                        this._PinYinAbbreviation = this._PinYinAbbreviation + chArray1[num4];
                    }
                    else
                    {
                        num3 = buffer1[1];
                        ...
                        {
                            for (int num5 = PinYin._PinYinValue.Length - 1; num5 >= 0; num5--)
                            {
                                if (PinYin._PinYinValue[num5] <= num1)
                                {
                                    this._PinYinFullCode = this._PinYinFullCode + PinYin._PinYinString[num5];
                                    this._PinYinFullCodeWithSpace = this._PinYinFullCodeWithSpace + PinYin._PinYinString[num5];
                                    this._PinYinFullCodeWithSpace = this._PinYinFullCodeWithSpace + " ";
                                    this._PinYinAbbreviation = this._PinYinAbbreviation + PinYin._PinYinString[num5].Substring(0, 1);
                                    break;
                                }
                            }
                        }
            ...
            -10322, -10315, -10309, -10307, -10296, -10281, -10274, -10270, -10262, -10260, -10256, -10254
                ...
                PinYin._PinYinString = new string[] { 
        ...
        {
            return _PY.GetAbbrName(name);
        }

        public static string GetFullName(string name)
        {
            return _PY.GetFullName(name);
        }

        public static string GetFullNameWithSpace(string name)
        {
            return _PY.GetFullNameWithSpace(name);
        }
    }
}
